...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>LogUcab | Airports List</title>
                    ...
                    <table class="table table-bordered table-hover dt-responsive custom-table" id="users-table">
                        ...
                        <tbody>
                            @foreach ($airports as $air)
                                <tr>
                                    <td>{{$air->aer_codigo}}</td>
                                    <td>{{$air->aer_cantidad_terminales}}</td>
                                    <td>{{$air->aer_cantidad_pistas}}</td>
                                    <td>{{$air->aer_capacidad}}</td>
                                    <td>{{$air->suc_nombre}}</td>
                                </tr>
                            @endforeach   
                        </tbody>
                    </table>
