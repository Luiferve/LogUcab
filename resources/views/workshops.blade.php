                            ...
                            @foreach ($workshops as $wor)
                                <tr>
                                    ...
                                    <div style="text-align: center">
                                        ...
                                        <a href="{{url('/workshops/'.$wor->tal_codigo)}}" class="edit_details" title="edit" >
                                            <img src="/img/edit.png" alt="Edit" width=20px></a>
                                        @endif
                                        @if (in_array(3,$permissions))
                                        <a href="{{url('/workshops/delete/'.$wor->tal_codigo)}}" class="delete_details"  title="delete" style="padding-left: 20px;">
